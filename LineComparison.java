...
class LengthOfLine{
      ...
      //Function for calculating the Length
        void findLength() {
            ...
            comparison(lengthOfLine2,lengthOfLine1);
      ...
      //Function for comparing lengths
        void comparison(double lengthOfLine1, double lengthOfLine2) {
...
3
The Line1 length is greater than Line2 length
